...
def main():
    ...
    problem = Problem(f)
    line_solver = QuasiNewtonMethod(FiniteDifferenceHessian(1e-5), DefaultStep(), 'cauchy', 1e-5, 1e-5)
    solver = QuasiNewtonMethod(FiniteDifferenceHessian(1e-5), ExactLineStep(line_solver, 1e-5), 'cauchy', 1e-5, 1e-5)
